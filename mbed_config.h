...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0x6E, 0x6A }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x49, 0x7E, 0x3C, 0x7A, 0x71, 0xA8, 0x92, 0xBE, 0x1D, 0x7D, 0x5E, 0x92, 0x5D, 0x5E, 0xF8, 0x26 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x00, 0x3D, 0x23, 0xC3, 0x5C, 0x5F, 0xCE, 0x23 }                                                 // set by application[*]
